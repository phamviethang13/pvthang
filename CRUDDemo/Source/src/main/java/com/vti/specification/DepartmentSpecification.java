    ...
    public static Specification<Department> buildSpec(DepartmentFilterForm form){
        ...
        return (root, query, builder) -> {
            ...
            if(form.getMinTotalMembers() != null) {
                predicates.add(builder.greaterThanOrEqualTo(root.get("totalMembers"), form.getMinTotalMembers()));
            }
            if(form.getMaxTotalMembers() != null) {
                predicates.add(builder.lessThanOrEqualTo(root.get("totalMembers"), form.getMaxTotalMembers()));
            }
            ...
            if(form.getMaxCreatedAt() != null) {
                predicates.add(builder.lessThanOrEqualTo(root.get("createdAt"), form.getMinTotalMembers()));
            }
            if(form.getMinCreatedYear() != null) {
                predicates.add(builder.greaterThanOrEqualTo(
                        builder.function("YEAR", Integer.class, root.get("createdAt")), form.getMinCreatedYear()));
            }
